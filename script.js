$(document).ready(function () {
  ...
  function iniciarMapa() {
    ...
    officeMarker
      .bindPopup("<b>São aqui os nossos escritórios, faça-nos uma visita!</b>")
      .openPopup();
        ...
        function (position) {
          ...
          L.Routing.control({
            ...
            createMarker: function (i, wp, n) {
              return L.marker(wp.latLng, { draggable: true }).bindPopup(
                i === 0 ? "O teu local atual" : "O nosso escritório"
              );
            },
          }).addTo(map);
